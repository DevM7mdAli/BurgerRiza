    ...
    <section class="bg-white shadow-md rounded-lg overflow-hidden p-6">
      <div class="flex flex-col gap-4">
        ...
        <div class="mt-6 flex items-center justify-between">
          ...
          <input onclick="window.location.href = 'checkout.php' " type="submit" name="checkout" value="Checkout" class="px-6 py-3 bg-green-500 text-white rounded hover:bg-green-600 transition duration-200">
        </div>
    </section>
  </div>
